...
extension ScreenModel {
    func buildComponents() throws -> [UIComponent] {
        ...
        for component in self.components {
            ...
            case .featuredImage:
                guard 
                    let uiModel: FeaturedImageUIModel = component.data.decode()
                else {
            ...
            case .carousel:
                guard 
                    let uiModel: CarouselUIModel = component.data.decode()
                else {
                    throw ComponentError.decodingError
                }
            ...
            case .textRow:
                guard
                    let uiModel: TextRowUIModel = component.data.decode()
                else {
                    throw ComponentError.decodingError
                }
            ...
            case .ratingRow:
                guard
                    let uiModel: RatingRowUIModel = component.data.decode()
                else {
                    throw ComponentError.decodingError
                }
            ...
            case .list:
                guard
                    let uiModel: ListUIModel = component.data.decode()
                else {
                    throw ComponentError.decodingError
                }
